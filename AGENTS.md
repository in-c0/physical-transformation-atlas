...
- Only a reviewed record in `data/canonical/searches` may make a cell or route say "no demonstration found". Automated index queries go to `data/generated/search-runs.json` via the pipeline and stay `inconclusive`.
