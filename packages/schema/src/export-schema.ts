...
export const Counts = z.object({
  ...
  editorial_scope_fill: z.number(),
  matrix_cells_without_search_record: z.number().int(),
  matrix_cells_with_direct_relation: z.number().int(),
  matrix_cells_status_not_searched: z.number().int(),
  routes_enumerated: z.number().int(),
  routes_with_recorded_composition_demonstration: z.number().int(),
  matrix_cells_without_direct_relation: z.number().int(),
  searches_reviewed: z.number().int(),
  searches_index_only: z.number().int(),
