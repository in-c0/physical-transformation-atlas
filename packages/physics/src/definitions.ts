...
export const CHECK_DEFINITIONS: CheckDefinition[] = [
  ...
  },
  {
    ...
    reads: [
      ...
      "pathway.bounds[].constraint (pass 42: the exact pathway's architecture-specific bounds, same machinery)",
  ...
  },
  {
    ...
    unresolved_when: "a performance record exists with notes but no structured datum",
    unknown_when: "no performance record exists for this composition (the honest state of an undemonstrated route)",
    reads: ["pathway.performance.measurements"],
    core: false,
