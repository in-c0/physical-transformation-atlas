...
export const CHECK_DEFINITIONS: CheckDefinition[] = [
  ...
  },
  {
    ...
    unresolved_when: "source exergy is positive but at least one step has no energy ledger entry",
  ...
  },
  {
    ...
    pass_when: "applicable bounds are recorded and no recorded efficiency exceeds the tightest numeric bound",
